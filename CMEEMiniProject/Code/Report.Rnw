\documentclass[fontsize=11pt]{scrartcl}	% KOMA
...
\linenumbers
  ...
  \begin{table}
    ...
    <<Sharpe-Schoolfield Parameter Summary, echo=FALSE, results='asis'>>=
    ...
    xt = xtable(summarize(Res_Data))
    suppressMessages(print(xt, 
